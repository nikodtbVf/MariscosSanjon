class MeasurementUnitsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @measurement_unit.save
        format.html { redirect_to @measurement_unit, notice: 'Unidad de medida creada exitosamente' }
  ...
  def update
    respond_to do |format|
      if @measurement_unit.update(measurement_unit_params)
        format.html { redirect_to @measurement_unit, notice: 'Unidad de medida editada correctamente' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to measurement_units_url, notice: 'Unidad de medida eliminada correctamente' }
